...
def trainer(args, train_loader, valid_loader, model,
    ...
    args.experiment_dir = os.path.join('runs',
                                        args.modeltype + '_' + args.trainset + '_' + args.constraint + '_ '+ args.addstring +'_' + datetime.now().strftime("_%Y_%m_%d_%H_%M_%S") +'_'+ str(args.s)+'x')
    ...
    for epoch in range(args.epochs):
        for batch_idx, item in enumerate(train_loader):
            ...
            # TODO: also perform backward loss and pply constraints there
