        ...
        for batch_idx, item in enumerate(train_loader):
            ...
            if step % args.log_interval == 0:
                ...
                with torch.no_grad():
                    ...
                    plt.figure()
                    plt.imshow(grid_low_res.permute(1, 2, 0)[:,:,0], cmap=cmap, vmin=args.vminmax[0], vmax=args.vminvmax[1])
                    plt.axis('off')
                    ...
                    plt.figure()
                    plt.imshow(grid_high_res_gt.permute(1, 2, 0)[:,:,0], cmap=cmap, vmin=args.vminmax[0], vmax=args.vminvmax[1])
                    plt.axis('off')
                    ...
                    plt.figure()
                    plt.imshow(grid_y_hat.permute(1, 2, 0)[:,:,0], cmap=cmap, vmin=args.vminmax[0], vmax=args.vminvmax[1])
                    plt.axis('off')
                    plt.title("Y hat")
                    ...
                    plt.figure()
                    plt.imshow(grid_abs_error.permute(1, 2, 0)[:,:,0], cmap=cmap, vmin=args.vminmax[0], vmax=args.vminvmax[1])
                    plt.axis('off')
                    plt.title("Abs Err")
