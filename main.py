...
def main(args):
    ...
    if args.modeltype == "srflow":
        ...
        if args.resume:
            modelname = 'model_epoch_3_step_72250.tar'
            modelpath = "/home/christina/Documents/clim-var-ds-cnf/runs/srflow_era5-TCW_2023_09_25_11_10_43/model_checkpoints/{}".format(modelname)
